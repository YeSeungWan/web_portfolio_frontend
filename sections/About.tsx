...
export default function About() {
  ...
  const aboutSections = [
    ...
    },
    {
      ...
      desc: "저에게 가장 중요한 것은 '왜 이렇게 동작하는가'를 묻고 함께 답을 찾아가는 동료들입니다. 단순히 돌아가기만 하는 코드를 짜는 것을 넘어, 하드웨어의 제약을 이해하고 최선의 타협점을 고민하는 과정을 즐깁니다. 기술적인 문제가 발생했을 때 혼자 안고 가기보다 투명하게 의견을 나누며, 제품의 완성도와 팀의 성장을 나란히 이뤄갈 수 있는 곳에서 일하고 싶습니다."
    }
  ];
